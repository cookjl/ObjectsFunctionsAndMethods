...
#           newWindow= rg.RoseWindow(100,100)
#
...
#            newWindow= rg.RoseWindow(600,100)
#
...
#            When working with several windows, if windows do not close they
#  will stack, which is annoying
#
